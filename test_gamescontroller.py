...
#
# ROSI games controller tester
# Use this program to detect a games controller and show you what inputs it has and what is being pressed.
            ...
            with ControllerResource() as joystick:
                while joystick.connected:
                    ...
                    for axis_name in joystick.axes.names:
                        ...
                        #print(axis_value)
                        green('{0}'.format(axis_value))
                        """
                        if axis_value > 0:
                            green('{1}'.format(axis_value))
                        elif axis_value < 0:
                            red('{1}'.format(axis_value))
                        else:
                            yellow('{1}'.format(axis_value))"""
